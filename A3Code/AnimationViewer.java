...
class AnimationViewer extends JComponent implements Runnable {
	...
	class MyMouseAdapter extends MouseAdapter {
		public void mouseClicked(MouseEvent e) {
			...
			if (!found) {		
				root.createInnerShape(e.getX(), e.getY(), getCurrentWidth(), getCurrentHeight(), currentColor, currentBorderColor, currentPathType, currentShapeType);
			}
		}
	}
	...
	class MyModel extends AbstractListModel<Shape> implements TreeModel{
		...
		public void reload(NestedShape selected){
			...
			fireContentsChanged(this, 0, selected.getAllInnerShapes().size());
		}
		...
		public Object getChild(Object parent, int index){
			if ((parent instanceof NestedShape) && (index >= 0) && (index <= getChildCount(parent)-1)){
		...
		public void insertNodeInto(Shape newChild, NestedShape parent){
			...
			fireTreeNodesInserted(this, ((Shape)parent).getPath(),  index, children);
			reload(parent);
		...
		public void addShapeNode(NestedShape selectedNode){
			...
			if (isRoot(selectedNode)){
				newChild = root.createInnerShape(0, 0, currentWidth, currentWidth, root.getColor(), root.getBorderColor(), getCurrentPathType(), getCurrentShapeType());
			}
				...
				newChild = selectedNode.createInnerShape(0, 0, selectedNode.getWidth()/2, selectedNode.getHeight()/2, selectedNode.getColor(), selectedNode.getBorderColor(), getCurrentPathType(), getCurrentShapeType());			
			}
		...
		public void removeNodeFromParent(Shape selectedNode){
			...
			fireIntervalRemoved(this, index[0], index[0]);
			fireTreeNodesRemoved(this, parent.getPath(), index, children);
			reload(parent);
		}
