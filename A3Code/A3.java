...
public class A3  extends JFrame {
	...
	class TreeNodeSelectionListener  implements TreeSelectionListener {
		public void valueChanged(TreeSelectionEvent e) {
			...
			if ((selected instanceof NestedShape) && (selected != null)){
				panel.model.reload((NestedShape)selected);
			}
		}
	}
	class AddListener implements ActionListener {
		public void actionPerformed( ActionEvent e) {
			...
			if((component instanceof NestedShape) && component != null){
				panel.model.addShapeNode((NestedShape)component);
				
			}else if (!(component instanceof NestedShape) && (component != null)){
	...
	class RemoveListener implements ActionListener {
		public void actionPerformed( ActionEvent e) {
			Object component = tree.getLastSelectedPathComponent();
			if ((component != null) && (panel.model.getRoot() != component)){
				panel.model.removeNodeFromParent((Shape)component);
			}
			else if (component == panel.model.getRoot()){
